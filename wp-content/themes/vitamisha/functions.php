...
if ( ! function_exists( 'vitamisha_setup' ) ) :
	...
	function vitamisha_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'vitamisha_custom_background_args', array(
 ...
 */
function vitamisha_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'vitamisha_content_width', 640 );
}
add_action( 'after_setup_theme', 'vitamisha_content_width', 0 );
...
function vitamisha_scripts() {
	...
	wp_enqueue_script( 'vitamisha-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
